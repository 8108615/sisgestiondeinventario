        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title"><b>Sucursales Registrados</b></h3>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <a href="{{ url('/admin/sucursales/' . $sucursal->id . '/edit') }}" class="btn btn-success"><i class="fas fa-pencil-alt"></i> Editar</a>
