                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input style="text-align: center" type="number" value="{{ old('precio_compra') }}" class="form-control"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input style="text-align: center" type="number" value="{{ old('precio_venta') }}" class="form-control"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input style="text-align: center" type="number" value="{{ old('stock_minimo') }}" class="form-control"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input style="text-align: center" type="number" value="{{ old('stock_maximo') }}" class="form-control"
